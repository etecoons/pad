//! Pad application configuration (flat struct).
//!
...
impl AppConfig {
    ...
    pub fn load_from_env(port: u16) -> Self {
        ...
        let pin = first_nonempty_env(&["Pad_PIN", "PIN"]).and_then(|p| {
...
mod tests {
    ...
    fn load_does_not_panic() {
        let cfg = AppConfig::load_from_env(4402);
